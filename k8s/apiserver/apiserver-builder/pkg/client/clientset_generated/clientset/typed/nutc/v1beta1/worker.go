...
import (
	...
	scheme "github.com/kairen/worker/pkg/client/clientset_generated/clientset/scheme"
...
type WorkerInterface interface {
	Create(*v1beta1.Worker) (*v1beta1.Worker, error)
	Update(*v1beta1.Worker) (*v1beta1.Worker, error)
	UpdateStatus(*v1beta1.Worker) (*v1beta1.Worker, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta1.Worker, error)
	List(opts v1.ListOptions) (*v1beta1.WorkerList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Worker, err error)
	WorkerExpansion
}
...
func newWorkers(c *NutcV1beta1Client, namespace string) *workers {
	return &workers{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *workers) Get(name string, options v1.GetOptions) (result *v1beta1.Worker, err error) {
	result = &v1beta1.Worker{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("workers").
		Name(name).
...
func (c *workers) List(opts v1.ListOptions) (result *v1beta1.WorkerList, err error) {
	result = &v1beta1.WorkerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("workers").
...
func (c *workers) Create(worker *v1beta1.Worker) (result *v1beta1.Worker, err error) {
	result = &v1beta1.Worker{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("workers").
...
func (c *workers) Update(worker *v1beta1.Worker) (result *v1beta1.Worker, err error) {
	result = &v1beta1.Worker{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("workers").
...
func (c *workers) UpdateStatus(worker *v1beta1.Worker) (result *v1beta1.Worker, err error) {
	result = &v1beta1.Worker{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("workers").
...
func (c *workers) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta1.Worker, err error) {
	result = &v1beta1.Worker{}
