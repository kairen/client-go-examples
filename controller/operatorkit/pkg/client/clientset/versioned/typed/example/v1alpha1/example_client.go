...
import (
	...
	"github.com/kairen/simple-operator/pkg/client/clientset/versioned/scheme"
...
// ExampleV1alpha1Client is used to interact with features provided by the example.io group.
type ExampleV1alpha1Client struct {
	restClient rest.Interface
}

func (c *ExampleV1alpha1Client) Employees(namespace string) EmployeeInterface {
	return newEmployees(c, namespace)
}
