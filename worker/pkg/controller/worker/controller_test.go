...
import (
	...
	. "github.com/kairen/worker/pkg/client/clientset_generated/clientset/typed/nutc/v1beta1"
...
var _ = Describe("Worker controller", func() {
	...
	BeforeEach(func() {
		...
		expectedKey = "worker-controller-test-handler/instance-1"
	})
	...
	Describe("when creating a new object", func() {
		It("invoke the reconcile method", func() {
			client = cs.NutcV1beta1().Workers("worker-controller-test-handler")
